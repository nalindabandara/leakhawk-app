...
def getResults():
    ...
    if len(jerar)==0:
        ...
        jerar.sort()
        out += algorithms[jerar[0]]+","
        out += algorithms[jerar[1]] 
    elif len(jerar)>0:
        jerar.sort()
        out += algorithms[jerar[0]]+","
        out += "" 
...
#        print item
        ...
        for word in words:
            ...
            if len(word) > letterCount:
                print '\n\nWord : '+word
                ADLER32(word);CRC16(word);CRC16CCITT(word);CRC32(word);CRC32B(word);DESUnix(word);DomainCachedCredentials(word);FCS16(word);GHash323(word);GHash325(word);GOSTR341194(word);Haval128(word);Haval128HMAC(word);Haval160(word);Haval160HMAC(word);Haval192(word);Haval192HMAC(word);Haval224(word);Haval224HMAC(word);Haval256(word);Haval256HMAC(word);LineageIIC4(word);MD2(word);MD2HMAC(word);MD4(word);MD4HMAC(word);MD5(word);MD5APR(word);MD5HMAC(word);MD5HMACWordpress(word);MD5phpBB3(word);MD5Unix(word);MD5Wordpress(word);MD5Half(word);MD5Middle(word);MD5passsaltjoomla1(word);MD5passsaltjoomla2(word);MySQL(word);MySQL5(word);MySQL160bit(word);NTLM(word);RAdminv2x(word);RipeMD128(word);RipeMD128HMAC(word);RipeMD160(word);RipeMD160HMAC(word);RipeMD256(word);RipeMD256HMAC(word);RipeMD320(word);RipeMD320HMAC(word);SAM(word);SHA1(word);SHA1Django(word);SHA1HMAC(word);SHA1MaNGOS(word);SHA1MaNGOS2(word);SHA224(word);SHA224HMAC(word);SHA256(word);SHA256s(word);SHA256Django(word);SHA256HMAC(word);SHA256md5pass(word);SHA256sha1pass(word);SHA384(word);SHA384Django(word);SHA384HMAC(word);SHA512(word);SHA512HMAC(word);SNEFRU128(word);SNEFRU128HMAC(word);SNEFRU256(word);SNEFRU256HMAC(word);Tiger128(word);Tiger128HMAC(word);Tiger160(word);Tiger160HMAC(word);Tiger192(word);Tiger192HMAC(word);Whirlpool(word);WhirlpoolHMAC(word);XOR32(word);md5passsalt(word);md5saltmd5pass(word);md5saltpass(word);md5saltpasssalt(word);md5saltpassusername(word);md5saltmd5pass(word);md5saltmd5passsalt(word);md5saltmd5passsalt(word);md5saltmd5saltpass(word);md5saltmd5md5passsalt(word);md5username0pass(word);md5usernameLFpass(word);md5usernamemd5passsalt(word);md5md5pass(word);md5md5passsalt(word);md5md5passmd5salt(word);md5md5saltpass(word);md5md5saltmd5pass(word);md5md5usernamepasssalt(word);md5md5md5pass(word);md5md5md5md5pass(word);md5md5md5md5md5pass(word);md5sha1pass(word);md5sha1md5pass(word);md5sha1md5sha1pass(word);md5strtouppermd5pass(word);sha1passsalt(word);sha1saltpass(word);sha1saltmd5pass(word);sha1saltmd5passsalt(word);sha1saltsha1pass(word);sha1saltsha1saltsha1pass(word);sha1usernamepass(word);sha1usernamepasssalt(word);sha1md5pass(word);sha1md5passsalt(word);sha1md5sha1pass(word);sha1sha1pass(word);sha1sha1passsalt(word);sha1sha1passsubstrpass03(word);sha1sha1saltpass(word);sha1sha1sha1pass(word);sha1strtolowerusernamepass(word);
                showResults();
                outs = '\n'+word +''+ getResults()
                wordlist += outs
                #print outs
                #wordlist += [word] # or wordlist.append(item) as in your first snippet
